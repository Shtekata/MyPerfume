namespace MyPerfume.Services.Data
{
    ...
    public class HeartNotesService : IHeartNotesService
    {
        private readonly IDeletableEntityRepository<HeartNote> deletableEntityRepository;

        public HeartNotesService(IDeletableEntityRepository<HeartNote> deletableEntityRepository)
        {
        ...
        {
            var model = new HeartNote { Name = input.Name };
        ...
        public HeartNote GetByIdModel(string id)
        {
