namespace MyPerfume.Services.Data
{
    ...
    public class AromaticGroupsService : IAromaticGroupsService
    {
        private readonly IDeletableEntityRepository<AromaticGroup> deletableEntityRepository;

        public AromaticGroupsService(IDeletableEntityRepository<AromaticGroup> deletableEntityRepository)
        {
        ...
        {
            var model = new AromaticGroup { Name = input.Name };
        ...
        {
            IQueryable<AromaticGroup> query = this.deletableEntityRepository.AllAsNoTracking()
            .OrderBy(x => x.Name);
            if (count.HasValue)
            {
