namespace MyPerfume.Services.Data
{
    ...
    public class CategoriesService : ICategoriesService
    {
        ...
        public CategoriesService(IDeletableEntityRepository<Category> deletableEntityRepository)
        {
        ...
        {
            var model = new Category { Name = input.Name };
        ...
        {
            IQueryable<Category> query = this.deletableEntityRepository.AllAsNoTracking()
            .OrderBy(x => x.Name);
            if (count.HasValue)
            {
        ...
        public Category GetByIdModel(string id)
        {
