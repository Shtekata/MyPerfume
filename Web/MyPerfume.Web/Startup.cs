namespace MyPerfume.Web
{
    ...
    using MyPerfume.Data.Seeding;
    using MyPerfume.Services.Data;
    using MyPerfume.Services.Mapping;
    using MyPerfume.Services.Messaging;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPerfumesService, PerfumesService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                new ApplicationDbContextSeeder().SeedAsync(dbContext, serviceScope.ServiceProvider, this.configuration).GetAwaiter().GetResult();
            }
