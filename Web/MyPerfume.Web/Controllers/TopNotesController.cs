namespace MyPerfume.Web.Controllers
{
    ...
    public class TopNotesController : BaseController
    {
        ...
        public async Task<IActionResult> Add(IdAndNameInputModel input)
        {
            ...
            await this.topNotesService.AddAsync(dto);
        ...
        public async Task<IActionResult> All()
        {
            ...
            var data = await this.topNotesService.GetAll<IdNameCreateModViewModel>();
        ...
        public async Task<IActionResult> Edit(IdAndNameInputModel input)
        {
            ...
            var isTheSameInput = this.topNotesService.IsTheSameInput(input);
            if (isTheSameInput)
            {
            ...
            var result = await this.topNotesService.EditAsync(input);
        ...
        public async Task<IActionResult> Delete(IdAndNameInputModel input)
        {
            ...
            var result = await this.topNotesService.DeleteAsync(input);
